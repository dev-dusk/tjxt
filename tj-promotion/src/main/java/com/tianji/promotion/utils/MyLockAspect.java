...
public class MyLockAspect implements Ordered {
    ...
    public Object tryLock(ProceedingJoinPoint point, MyLock myLock) throws Throwable {
//        RLock lock = redissonClient.getLock(myLock.key());
        String lockName = getLockName(myLock.key(), point);
        RLock lock = myLockFactory.getLock(myLock.lockType(), lockName);
//        boolean tryLock = lock.tryLock(myLock.waitTime(), myLock.expireTime(), myLock.timeUnit());
